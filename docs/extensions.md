...
- Reserved shortcuts are ignored (`ctrl+c`, `ctrl+d`, `ctrl+z`, `ctrl+k`, `ctrl+p`, `ctrl+l`, `ctrl+o`, `ctrl+t`, `ctrl+g`, `ctrl+q`, `alt+m`, `alt+p`, `shift+tab`, `shift+ctrl+p`, `shift+f1`, `shift+f2`, `alt+enter`, `escape`, `enter`).
