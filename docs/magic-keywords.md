...
| `fullsend`    | Makes speed and verified quality joint top priorities without monetary or token constraints. It chooses the shortest expected completion time under equal correctness, completeness, and verification standards, and delegates only when delegation yields real speed or verification benefit. Required verification remains mandatory. |
