...
- **版本**：`v18.1.2`
- **Upstream commit**：`18781d829586fff77af98b222728b5b29bcaba41`
- **同步日期**：2026-09-01
- **Integration**：`6376f8d470`

## 上游同步记录

- 2026-09-01：合入 `can1357/oh-my-pi@main` 的 `18781d829586`（package `18.1.2`，integration `6376f8d470`）。
