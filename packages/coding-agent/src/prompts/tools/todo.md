...
Before work, init for 3+ independent user-facing outcomes (a routine check → execute → verify chain counts as one), requested task sets, or new instructions. MUST list EVERY user item separately (phased/numbered/bulleted/N); NEVER omit or remember leftovers.
